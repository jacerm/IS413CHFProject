# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-23 16:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wholesale_cost', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('product_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='catalog.Product')),
                ('status', models.TextField(blank=True, choices=[('Available', 'Available'), ('Unavailable', 'Unavailable')], null=True)),
            ],
            options={
                'abstract': False,
            },
