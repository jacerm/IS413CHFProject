...
_magic_number = 10
_modified_time = 1456253501.9532745
_enable_loop = True
_template_filename = 'C:/source/class/IS413/class_project/class_project/event/templates/events.html'
_template_uri = 'events.html'
_source_encoding = 'utf-8'
import os, os.path, re, json
_exports = ['content_head', 'left_aside', 'right_aside', 'main']
...
def render_main(context,**pageargs):
    ...
    try:
        ...
        events = context.get('events', UNDEFINED)
        __M_writer = context.writer()
        __M_writer('\r\n<a href="/event/events.create/" class="btn btn-primary" style="margin-bottom: 15px;">Create New Event</a>\r\n   <table class="table table-striped">\r\n       <tr>\r\n           <th>Name</th>\r\n           <th>Description</th>\r\n           <th>Start Date</th>\r\n           <th>End Date</th>\r\n           <th>Venue</th>\r\n           <th>Actions</th>\r\n       </tr>\r\n')
        for event in events:
            __M_writer('       <tr>\r\n           <td>')
            ...
            __M_writer('</td>\r\n           <td><a href="/event/events.edit/')
            __M_writer(str(event.id))
            __M_writer('/">Edit</a> | <a class="events_delete_link" href="/event/events.delete/')
            __M_writer(str(event.id))
            __M_writer('/">Delete</a></td>\r\n       </tr>\r\n')
        __M_writer('   </table>\r\n   \r\n<div class="modal fade" id="events_delete_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">\r\n  <div class="modal-dialog" role="document">\r\n    <div class="modal-content">\r\n      <div class="modal-header">\r\n        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>\r\n        <h4 class="modal-title" id="myModalLabel">Modal title</h4>\r\n      </div>\r\n      <div class="modal-body">\r\n        Delete This Event?\r\n      </div>\r\n      <div class="modal-footer">\r\n        <a id="events_confirm_delete_modal" href="" class="btn btn-danger">Delete</a>\r\n        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
"""
__M_BEGIN_METADATA
{"source_encoding": "utf-8", "uri": "events.html", "line_map": {"67": 3, "133": 127, "73": 3, "79": 9, "121": 29, "85": 9, "57": 52, "47": 7, "28": 0, "97": 54, "91": 54, "103": 12, "42": 1, "110": 12, "111": 23, "112": 24, "113": 25, "114": 25, "115": 26, "116": 26, "117": 27, "118": 27, "119": 28, "120": 28, "52": 10, "122": 29, "123": 30, "124": 30, "125": 30, "126": 30, "127": 33}, "filename": "C:/source/class/IS413/class_project/class_project/event/templates/events.html"}
__M_END_METADATA
"""
